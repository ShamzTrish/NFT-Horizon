        ...
        <section className={`${styles.paddings} relative z-10`}>
            ...
            >
                <motion.div
                    ...
                    className='flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#686868] relative'
                >
                    <div className='feedback-gradient' />

                    {/* LEFT BOX */}
                    <div className=''>
                        <h4 className='font-bold sm:text-[32px] text-[26px] sm:leading-[40px] leading-[36px] text-white'>PATRICIE</h4>
